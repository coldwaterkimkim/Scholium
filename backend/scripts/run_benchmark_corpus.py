...
def _benchmark_defaults() -> dict[str, Any]:
    return {
        ...
        "rendered_pages": None,
        "upload_to_render_seconds": None,
        "upload_to_parser_map_ready_seconds": None,
        "upload_to_semantic_guide_ready_seconds": None,
        "upload_to_viewer_ready_seconds": None,
        "semantic_guide_time_seconds": None,
        "page_element_count": None,
        "page_guide_count": None,
        "pass1_parser_first_pages": None,
        ...
        "codex_cli_pass1_call_count": None,
        "codex_cli_semantic_guide_call_count": None,
        "codex_cli_selection_call_count": None,
