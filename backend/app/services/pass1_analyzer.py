...
class Pass1Analyzer:
    ...
    def analyze_page(
        ...
        try:
            self.storage.update_page_pass1_status(document_id, page_number, StageStatus.PENDING)
        ...
        if page_record.render_status is not RenderStatus.RENDERED:
            self.storage.update_page_pass1_status(document_id, page_number, StageStatus.FAILED)
            return self._failed_page_result(
                document_id=document_id,
                page_number=page_number,
        ...
        try:
            ...
            self.storage.update_page_pass1_status(document_id, page_number, StageStatus.COMPLETED)
