...
Prompt version: semantic_guide_v0_1
Schema version: 0.2
...
- If `response_language` is `"ko"`, write every student-facing DocumentGuide and PageGuide string in Korean.
- If `response_language` is `"en"`, write every student-facing DocumentGuide and PageGuide string in English.
- Keep JSON keys in English exactly as specified.
- Do not mix languages except for source terms that appear in the PDF/deck.
